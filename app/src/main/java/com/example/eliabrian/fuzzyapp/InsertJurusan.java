...
public class InsertJurusan extends AppCompatActivity implements View.OnClickListener{
    ...
    private static String url_insert_jurusan = "http://10.0.2.2/PHP%20Beasiswa/create_jurusan.php";
    ...
    private class insertProcess extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try{
                jsonObject = jsonParser.getJsonObject(url_insert_jurusan, "POST", args);
            }catch (IOException e){
